<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:10:{s:64:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/movetool.htm";i:1585620672;s:83:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_start.htm";i:1585620676;s:81:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_end.htm";i:1585620676;s:77:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/commer_header.htm";i:1585620676;s:67:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/header_left.htm";i:1585620672;s:0:"";b:0;s:76:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_right.htm";i:1585620676;s:60:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/left.htm";i:1585620672;s:68:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/right_header.htm";i:1585620672;s:77:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/footer_simple.htm";i:1585620676;}*/?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="./data/template/admin_cloud_movetool_header_zh-cn.js" ></script><script type="text/javascript" src="static/js/header.js?<?php echo VERHASH;?>" ></script>
...
<script type="text/javascript" src="static/js/jquery.leftDrager.js?<?php echo VERHASH;?>" ></script><script type="text/javascript" src="./data/template/admin_cloud_movetool_common_zh-cn.js" ></script><script type="text/javascript" src="static/js/common.js?<?php echo VERHASH;?>" ></script>
</head>
...
<div class="bs-container clearfix">
  ...
  <li <?php if($_GET['op']=='movetool') { ?>class="active"<?php } ?>><a href="<?php echo BASESCRIPT;?>?mod=cloud&op=movetool">迁移工具</a>
    ...
    <div class="main-content clearfix" style="padding:15px;border-top:1px solid #FFF" >
      <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=cloud&op=movetool" class="form-horizontal form-horizontal-left"  method="post" name="cpform" onsubmit="return validate(this);">
        ...
        <dl>
          ...
          <dd class="clearfix">
            <select name="remoteid" class="form-control" style="width:250px">
              ...
              <option value="<?php echo $value['remoteid'];?>" <?php if($router['remoteid']==$value['remoteid']) { ?>selected="selected" 
              <?php } ?>><?php echo $value['name'];?>(<?php echo $value['fusesize'];?> / <?php echo $value['ftotalsize'];?>)
              </option>
              <?php } ?>
            </select>
            <ul class="help-block ">
        ...
        <dl>
          ...
          <dd class="clearfix">
            <select name="oremoteid" class="form-control" style="width:250px">
              <?php if(is_array($spaces)) foreach($spaces as $value) { ?>              <option value="<?php echo $value['remoteid'];?>" ><?php echo $value['name'];?>(<?php echo $value['fusesize'];?> / <?php echo $value['ftotalsize'];?>)</option>
              <?php } ?>
            </select>
            <ul class="help-block ">
              <li>标志符：此类的唯一标志，全站唯一,注意区分大小写</li>
        ...
        <dl>
          <dt> <a href="javascript:;" onclick="jQuery('#filter').toggle(); document.getElementById('filter_guide').className=(document.getElementById('filter_guide').className=='glyphicon glyphicon-chevron-down'?'glyphicon glyphicon-chevron-up':'glyphicon glyphicon-chevron-down');">筛选条件&nbsp;<i id="filter_guide"  class="glyphicon glyphicon-chevron-down"></i></a> </dt>
        </dl>
...
<script type="text/javascript">
 ...
 var  spaces=<?php echo $spaces_json;?>;
