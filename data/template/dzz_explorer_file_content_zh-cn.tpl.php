<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:6:{s:79:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/file_content.htm";i:1589275828;s:91:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/template_file_middleicon.htm";i:1589275828;s:95:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/template_file_detaillist_cat.htm";i:1589275828;s:91:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/template_file_toolButton.htm";i:1589275828;s:91:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/template_file_navtopfile.htm";i:1589275828;s:84:"/opt/lampp/htdocs/dzzoffice/dzzoffice//./dzz/explorer/template/noFilePage-search.htm";i:1589275828;}*/?>
...
<p class="own-label">扩展名：</p>
<ul class="own-type ext"><?php if(is_array($cattext)) foreach($cattext as $v) { ?><li class="search-select"><span class="label label-glitter border-glitter" data-ext="<?php echo $v;?>">*<?php echo $v;?></span><img src="<?php echo MOD_PATH;?>/img/ic-filtrate.png" style="display: none;" class="label-rightimg"></li>
<?php } ?>
</ul>
</div>
<div class="form-group file-editcon">
<p class="own-label">标签：</p>
<ul class="own-type tag"><?php if(is_array($tagarr)) foreach($tagarr as $val) { ?><li class="search-select"><span class="label label-glitter border-glitter" data-tid="<?php echo $val['tid'];?>"><?php echo $val['tagname'];?></span><img src="<?php echo MOD_PATH;?>/img/ic-filtrate.png" style="display: none;" class="label-rightimg"></li>
<?php } ?>
</ul>
</div>

</div>
<button type="button" class="btn btn-primary share-editbutton" onclick="showWindow('editcatsearch','<?php echo MOD_URL;?>&op=ajax&operation=addsearchcat&id=<?php echo $catid;?>','get',0)">
<span class="dzz dzz-create"></span>
编辑</button>
</div>
</div>

            <div id="filemanage-cat-<?php echo $catid;?>"></div>
        </div>
</div>
...
<p class="emptyPage-text">没有符合条件的文件</p>
</div></div>
