<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:3:{s:60:"/opt/lampp/htdocs/dzzoffice//./dzz/word/template/setting.htm";i:1585640819;s:83:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_start.htm";i:1585620676;s:81:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_end.htm";i:1585620676;}*/?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="./data/template/dzz_word_setting_header_zh-cn.js" ></script><script type="text/javascript" src="static/js/header.js?<?php echo VERHASH;?>" ></script>
...
<script type="text/javascript" src="./data/template/dzz_word_setting_index_zh-cn.js" ></script><script type="text/javascript" src="<?php echo MOD_PATH;?>/scripts/index.js?<?php echo VERHASH;?>" ></script>
<style>
    body {
        min-width: 520px;
    }
...
</style><script type="text/javascript" src="./data/template/dzz_word_setting_common_zh-cn.js" ></script><script type="text/javascript" src="static/js/common.js?<?php echo VERHASH;?>" ></script>
</head>
