...
<head>
    ...
    <script type="text/javascript" src="./data/template/dzz_market_market_header_zh-cn.js"></script>
    ...
    <script type="text/javascript" src="./data/template/dzz_market_market_common_zh-cn.js"></script>
    ...
    <div class="bs-main-container">
        <div class="main-header clearfix">
            <ul class="nav navbar-nav nav-pills-bottomguide">
                ...
                </li><?php if (is_array($tags)) foreach ($tags as $value) { ?>
                    <li <?php if ($tagid == $value['tagid']) { ?>class="active"<?php } ?>>
        ...
        <div class="main-content clearfix">
            <table class="table table-hover">
                ...
                </thead><?php if (is_array($list)) foreach ($list as $value) { ?>
                    <tr>
                        <td>
                            <a href="<?php echo $value['url']; ?>" target="_blank"
                               isinstall="<?php echo $value['isinstall']; ?>"
                               onclick="return Preview('<?php echo $value['appid']; ?>');" title="预览"><img
                                        src="<?php echo $value['appico']; ?>"/><?php echo $value['appname']; ?></a>
                        </td>
                        <td><?php echo $value['vendor']; ?></td>
                        <td><?php if (is_array($value['tags'])) foreach ($value['tags'] as $key => $value1) { ?><a
                                href="<?php echo DZZSCRIPT; ?>?mod=market&tagid=<?php echo $value1['tagid']; ?>"><?php echo $value1['tagname']; ?></a>
                            <?php } ?>
                        </td>
                        <td>
                            <?php if ($value['isinstall']) { ?>
                                ...
                                <?php if ($value['notdelete'] == 0) { ?>
                                    <a href="javascript:;" data-notdelete="<?php echo $value['notdelete']; ?>"
                                       onclick="appUninstall(this,'<?php echo $value['appid']; ?>')">&nbsp;卸载</a>
                                <?php }
                            } else { ?>
                                <a id="app_<?php echo $value['appid']; ?>" href="javascript:;"
                                   data-notdelete="<?php echo $value['notdelete']; ?>"
                                   isinstall="<?php echo $value['isinstall']; ?>"
                                   onclick="Install(this,'<?php echo $value['appid']; ?>')"><span>安装</span></a>
                            <?php } ?>
                        </td>
                    </tr>
                <?php }
