...
<script type="text/javascript" src="./data/template/dzz_onlyoffice_main_header_zh-cn.js" ></script><script type="text/javascript" src="static/js/header.js?<?php echo VERHASH;?>" ></script>
...
<script type="text/javascript" src="<?php echo $onlyDocumentUrl;?>" ></script><script type="text/javascript" src="./data/template/dzz_onlyoffice_main_common_zh-cn.js" ></script><script type="text/javascript" src="static/js/common.js?<?php echo VERHASH;?>" ></script>
</head>
<body id="nv_<?php echo $_G['basescript'];?>" class="<?php echo $bodyClass;?>" >
<div id="append_parent" style="z-index:99999;"></div>
<div id="ajaxwaitid" style="z-index:99999;"></div><style>
html,body{
height:100%;
overflow:hidden;
}
