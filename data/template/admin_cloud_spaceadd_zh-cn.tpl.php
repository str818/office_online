<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:9:{s:64:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/spaceadd.htm";i:1585620672;s:83:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_start.htm";i:1585620676;s:81:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_end.htm";i:1585620676;s:77:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/commer_header.htm";i:1585620676;s:67:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/header_left.htm";i:1585620672;s:0:"";b:0;s:76:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_right.htm";i:1585620676;s:60:"/opt/lampp/htdocs/dzzoffice//./admin/cloud/template/left.htm";i:1585620672;s:77:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/footer_simple.htm";i:1585620676;}*/?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="./data/template/admin_cloud_spaceadd_header_zh-cn.js" ></script><script type="text/javascript" src="static/js/header.js?<?php echo VERHASH;?>" ></script>
...
<link href="<?php echo MOD_PATH;?>/images/connect.css?<?php echo VERHASH;?>" rel="stylesheet" media="all">
<script type="text/javascript" src="static/js/jquery.leftDrager.js?<?php echo VERHASH;?>" ></script><script type="text/javascript" src="./data/template/admin_cloud_spaceadd_common_zh-cn.js" ></script><script type="text/javascript" src="static/js/common.js?<?php echo VERHASH;?>" ></script>
</head>
      ...
      <div style="padding:15px;"> 
        ...
        <ul class="thumbnails list-unstyled clearfix">
          <?php if(is_array($value['list'])) foreach($value['list'] as $value1) { ?>          <li bz="<?php echo $value1['bz'];?>" data_type="<?php echo $key;?>" class="cloud-item span2">
            <div class="thumbnail"> <img src="dzz/images/default/system/<?php echo $value1['bz'];?>.png" width="100" />
