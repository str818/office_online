<?php if (!defined('IN_DZZ')) exit('Access Denied'); /*a:7:{s:58:"/opt/lampp/htdocs/dzzoffice//./dzz/word/template/index.htm";i:1585640819;s:83:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_start.htm";i:1585620676;s:81:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_simple_end.htm";i:1585620676;s:77:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/commer_header.htm";i:1585620676;s:64:"/opt/lampp/htdocs/dzzoffice//./dzz/word/template/header_left.htm";i:1585640819;s:66:"/opt/lampp/htdocs/dzzoffice//./dzz/word/template/header_search.htm";i:1585640819;s:76:"/opt/lampp/htdocs/dzzoffice//./core/template/default/common/header_right.htm";i:1585620676;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <meta name="keywords" content="<?php if (!empty($_G['setting']['metakeywords'])) {
        echo htmlspecialchars($_G['setting']['metakeywords']);
    } ?>"/>
    <meta name="description" content="<?php if (!empty($_G['setting']['metadescription'])) {
        echo htmlspecialchars($_G['setting']['metadescription']); ?> <?php } ?>"/>
    ...
    <script type="text/javascript">var DZZSCRIPT = '<?php echo DZZSCRIPT;?>', LANG = '<?php echo $_G['language'];?>',
            ...
            charset = '<?php echo CHARSET;?>', dzz_uid = '<?php echo $_G['uid'];?>',
            cookiepre = '<?php echo $_G['config']['cookie']['cookiepre'];?>',
            cookiedomain = '<?php echo $_G['config']['cookie']['cookiedomain'];?>',
            cookiepath = '<?php echo $_G['config']['cookie']['cookiepath'];?>',
            attackevasive = '<?php echo $_G['config']['security']['attackevasive'];?>',
            disallowfloat = '<?php echo $_G['setting']['disallowfloat'];?>',
            REPORTURL = '<?php echo $_G['currenturl_encode'];?>', SITEURL = '<?php echo $_G['siteurl'];?>',
            JSPATH = '<?php echo $_G['setting']['jspath'];?>', MOD_PATH = '<?php echo MOD_PATH;?>',
            APP_URL = '<?php echo MOD_URL;?>', MOD_URL = '<?php echo MOD_URL;?>';</script>
    <script type="text/javascript" src="./data/template/dzz_word_index_header_zh-cn.js"></script>
    <script type="text/javascript" src="static/js/header.js?<?php echo VERHASH; ?>"></script>
    ...
    <![endif]--><?php Hook::listen('header_tpl') ?>
    ...
    <script type="text/javascript" src="./data/template/dzz_word_index_index_zh-cn.js"></script>
    <script type="text/javascript" src="<?php echo MOD_PATH; ?>/scripts/index.js?<?php echo VERHASH; ?>"></script>
    <script type="text/javascript"
            src="<?php echo MOD_PATH; ?>/scripts/image_resize.js?<?php echo VERHASH; ?>"></script>
    <style>
        body {
    ...
    <script type="text/javascript" src="./data/template/dzz_word_index_common_zh-cn.js"></script>
    <script type="text/javascript" src="static/js/common.js?<?php echo VERHASH; ?>"></script>
</head>
        ...
        <ul class="nav navbar-nav navbar-nav-left" style="min-width:168px">
            <li>
                <a class="leftTopmenu" onclick="" style="padding:8px;cursor: pointer;">
                    <div class="gb_fc"><span class="dzz dzz-menu" style="width:24px;height:24px;display:block;"></span>
                    </div>
                </a>
            </li>
            <li>
    ...
    <div class="resNav-item resNav-center">
        ...
        <div class="input-search">
            <form name="search" action="<?php echo BASESCRIPT; ?>" method="get" class="search_top">
                ...
                <i class="input-search-icon glyphicon glyphicon-search" aria-hidden="true"
                   onclick="jQuery('form').submit()"></i>

                <input id="searchval" class="form-control search form-search" name="keyword"
                       placeholder="<?php echo lang(search) ?>" type="text" value="<?php echo $_GET['keyword']; ?>"
                       placeholder=""/>
    ...
    <div class="resNav-item resNav-right">
        <ul class="nav navbar-nav">
            ...
            <li class="app_popup-parent">
                ...
                <a href="javascript:;" id="desktop_app"
                   data-href="index.php?mod=system&amp;op=app_ajax&amp;operation=app" class="app_popup_icon js-popbox"
                   data-placement="bottom" data-trigger="focus" data-auto-adapt="true" data-toggle="popover"><span
                            class="dzz dzz-apps basil"></span></a>
            </li>
            <li>
                <a href="javascript:;" id="dzz_notification"
                   data-href="index.php?mod=system&amp;op=notification&amp;filter=new" class="navbar-notice js-popbox"
                   data-placement="bottom" data-trigger="focus" data-auto-adapt="true" data-toggle="popover">
                    <span class="dzz dzz-notifications"></span>
                    <span class="badge hide">&nbsp;</span>
                </a>
            </li>
            <li>
                <a href="javascript:;" class="imgHeight js-popbox"
                   data-href="user.php?mod=space&amp;op=navmenu&amp;modname=<?php echo MOD_NAME; ?>"
                   data-placement="bottom" data-trigger="focus" data-auto-adapt="true"
                   data-toggle="popover"><?php echo avatar_block($_G[uid]); ?></a>
            </li>
        </ul>
    </div>
</nav>
...
//仅窗口不在焦点时闪烁title，回到焦点时停止闪烁并将title恢复正常
        ...
        _notice.flashStep++;
        if (_notice.flashStep == 3) {
            _notice.flashStep = 1;
        }
        if (_notice.flashStep == 1) {
            document.title = "【您有新的通知】";
        }
        if (_notice.flashStep == 2) {
            document.title = "【　　　　　　】";
        }
        setTimeout(function () {
            _notice.flashTitle();
    ...
    <ul class="nav navbar-nav navbar-nav-left view-navbar-nav-left">
        <li>
            <a href="<?php echo MOD_URL; ?>" style="padding: 8px;">
                <div class="gb_fc"><span class="dzz dzz-chevron-left"
                                         style="width: 24px;height: 24px;display: block;font-size: 36px;position: relative;top: -6px;left: -6px;"></span>
                </div>
            </a>
        </li>
        <li>
...
<div class="bs-container clearfix" style="height: 100%">
    <div class="bs-left-container  clearfix" style="height: 100%;z-index: 1000;">
        ...
        <div class="leftItem">
            <ul class="left-ul">
                <li><a class="setting" href="<?php echo MOD_URL; ?>&op=ajax&do=setting"><i
                                class="dzz dzz-settings"></i> <?php echo lang('settings') ?></a></li>
            </ul>
        </div>
    </div>
    <div class="bs-main-container"
         style="padding-top: 64px;<?php if (!$setting['tplhide']) { ?>padding-bottom: 64px;<?php } ?>">
        <div class="main-content container clearfix" id="itemContainer"
             style="padding:0;height: 100%;width: 100%;overflow: auto;<?php if ($setting['tplhide']) { ?>margin-top: -64px;<?php } ?>position: relative;">
            <div class="template-wrap"
                 style="<?php if (!$setting['tplhide']) { ?>height: 0px;position:fixed;top: 64px;<?php } ?>">
                <div class="temp-top clearfix">
                    <div class="topwrap clearfix">
                        <div class="new"><?php echo lang('create_file') ?></div>
                        <div class="list" onclick="showTemp(this)"><?php echo lang('tpl_bank') ?> <i
                                    class="dzz dzz-expand-more"></i></div>
                        <?php if ($_G['adminid']) { ?><a href="index.php?mod=word&amp;op=tplmanage" class="manage"><i
                                class="dzz dzz-create"></i> <?php echo lang('tpl_manage') ?></a><?php } ?>
                    </div>
                    <div class="temp-container clearfix">
                        <div class="all-temp clearfix">
                            <div class="use clearfix">
                                <a class="temp-item add-temp" style="cursor: pointer;"
                                   onclick="showWindow('addemptydoc-window','<?php echo MOD_URL; ?>&op=ajax&do=showwindow&operation=addemptydoc')">
                                    <div class="add-img"><i class="dzz dzz-add"></i></div>
                                    <div class="temp-info null">
                                        <div class="temp-name"><?php echo lang('null') ?></div>
                                    </div>
                                </a>
                                <?php if (is_array($lately_tpl)) foreach ($lately_tpl as $value) { ?>
                                    <a class="temp-item" style="cursor: pointer;"
                                       onclick="showWindow('addbytpl-window','<?php echo MOD_URL; ?>&op=ajax&do=showwindow&operation=addbytpl&tid=<?php echo $value['tid']; ?>')">
                                        <div class="temp-img"><img onload="image_resize(this)"
                                                                   src="<?php echo $value['img']; ?>" alt=""></div>
                                        <div class="temp-info">
                            ...
                            <?php if (is_array($data)) foreach ($data as $key => $value) { ?>
                                <div class="resume clearfix">
                                    ...
                                    <?php if (is_array($value)) foreach ($value as $val) { ?>
                                        <a class="temp-item" style="cursor: pointer;"
                                           onclick="showWindow('addbytpl-window','<?php echo MOD_URL; ?>&op=ajax&do=showwindow&operation=addbytpl&tid=<?php echo $val['tid']; ?>')">
                                            <div class="temp-img"><img onload="image_resize(this)"
                                                                       src="<?php echo $val['img']; ?>" alt=""></div>
                                            <div class="temp-info">
            ...
            <div class="btn-file-wrap clearfix <?php if (!$setting['tplhide']) { ?>fix-nav<?php } ?>"
                 style="<?php if (!$setting['tplhide']) { ?>top: 64px; position: fixed;<?php } ?>">
                <div class="btn-file clearfix">
                    <div class="btnGroup">
                        <a href='javascript:;' onclick="switchShowType(this)"><i
                                    class="dzz <?php if ($showtype == 'list') { ?>dzz-view-list<?php } else { ?>dzz-view-module<?php } ?>"
                                    data-toggle="tooltip" data-placement="bottom"
                                    title="<?php echo lang('view_tab') ?>"></i></a>
                        <div class="dropdown" style="display: inline-block;">
                            <a class="btn btn-more dropdown-toggle"
                               style="padding: 12px;display: inline-block;vertical-align: 0px;opacity:1;border: none;"
                               type="button" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true"
                               aria-expanded="false">
                                <i class="dzz dzz-paixu" data-toggle="tooltip" data-placement="bottom"
                                   title="<?php echo lang('tpl_sort') ?>"></i>
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu4" style="margin-top: 0;left:-70px;">
                                <li><a style="cursor: pointer;"
                                       onclick="loadmore('&keyword=<?php echo $_GET['keyword']; ?>&order=open')"><?php echo lang('open_time') ?></a>
                                </li>
                                <li><a style="cursor: pointer;"
                                       onclick="loadmore('&keyword=<?php echo $_GET['keyword']; ?>&order=edit')"><?php echo lang('edit_time') ?></a>
                                </li>
                                <li><a style="cursor: pointer;"
                                       onclick="loadmore('&keyword=<?php echo $_GET['keyword']; ?>&order=name')"><?php echo lang('tpl_title') ?></a>
                                </li>
                            </ul>
                        </div>

                        <a style="cursor: pointer;" class="sel-folder" data-toggle="tooltip" data-placement="bottom"
                           title="<?php echo lang('open_file_selection') ?>"><i class="dzz dzz-folder"></i>
                            <input type="file" name="files[]" class="upload" multiple="multiple" title=" "
            ...
            <div class="edit-wrap" style="<?php if (!$setting['tplhide']) { ?>padding-top: 20px<?php } ?>">
                <div class="edit-scroll">
                    <div class="edit">
                        ...
                        <div class="edit-use">
                            <div class="loader"
                                 data-turl="&keyword=<?php echo $_GET['keyword']; ?>&order=<?php echo $_GET['order']; ?>"
                                 data-next="0">
    ...
    <div id="publish_stick" class="m-g H" style="<?php if (!$setting['tplhide']) { ?>display: block;<?php } ?>">
        ...
        <div class="vc">
            <?php if ($_G['adminid']) { ?>
                <div class="V">
                    <a class="r nX file-btn" href="index.php?mod=word&amp;op=tplmanage"><i class="dzz dzz-dashboard"
                                                                                           style="opacity: 1"></i></a>
                    <label class="bA lN">
...
<script type="text/javascript"
        src="static/jquery_file_upload/jquery.iframe-transport.js?<?php echo VERHASH; ?>"></script>
<!-- The basic File Upload plugin -->
<script type="text/javascript" src="static/jquery_file_upload/jquery.fileupload.js?<?php echo VERHASH; ?>"></script>
<script type="text/javascript"
        src="static/jquery_file_upload/jquery.fileupload-process.js?<?php echo VERHASH; ?>"></script>
<script type="text/javascript" src="./data/template/dzz_word_index_jquery_fileupload-validate_zh-cn.js"></script>
<script type="text/javascript"
        src="static/jquery_file_upload/jquery.fileupload-validate.js?<?php echo VERHASH; ?>"></script>